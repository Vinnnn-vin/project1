...
function App() {
  ...
  const services = [
    {
      ...
      description: "Dapatkan bimbingan dari para profesional yang memahami branding dan juga goal bisnis",
    },
    {
      title: "KONSISTENSI MENJADI UTAMA",
      description: "Kembangkan identitas merek yang konsisten agar dapat dikenali di masyarakat",
    },
    {
      title: "EFESIENSI WAKTU DAN BIAYA",
      description: "Menghemat waktu dan biaya dengan mempercayakan tugas branding kepada KOSI.",
    },
  ];
  ...
  const socialIcons = [
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-8 h-8">
          <path fill="" d="M448 209.9a210.1 210.1 0 0 1-122.8-39.3v178.8A162.6 162.6 0 1 1 185 188.3v89.9a74.6 74.6 0 1 0 52.2 71.2V0h88a121.2 121.2 0 0 0 1.9 22.2 122.2 122.2 0 0 0 53.9 80.2 121.2 121.2 0 0 0 67 20.7z" />
        </svg>
      ),
      name: "TikTok",
    },
  ...
  const row1 = [
    ...
    {
      id: 8,
      image: "public/images/logo client/WhatsApp_Image_2024-12-31_at_10.14.56__1_-removebg-preview.png",
      alt: "SCBD",
    },
    {
      id: 9,
      image: "public/images/logo client/WhatsApp_Image_2024-12-31_at_10.14.56__2_-removebg-preview.png",
      alt: "Branded Plus",
    },
    {
      id: 10,
      image: "public/images/logo client/WhatsApp_Image_2024-12-31_at_10.14.57__1_-removebg-preview.png",
      alt: "Dokter?",
    },
  ];
