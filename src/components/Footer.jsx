    ...
    <footer className="bg-yellow-400 px-4 sm:px-8 py-12">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <p className="mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.</p>
          <div className="flex gap-2 text-black">
            <input type="email" placeholder="Email" className="flex-1 px-4 py-2 rounded" />
            <button className="bg-green-500 text-white px-6 py-2 rounded hover:bg-green-600">Send</button>
          </div>
        </div>
      </div>
