      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="flex flex-col text-black">
          <div className="flex text-black">
            <img src="../../public/images/Kosi Logo Black.png" alt="" />
        ...
        <div>
          ...
          <div className="pt-8">
            <h3 className="text-xl mb-4 text-black">
              <b>
                Dapatkan Penawaran Menarik dan Pelayanan Yang Terbaik Sekarang!
              </b>
            </h3>
            <button className="w-full bg-green-600 text-white py-3 px-3 rounded-lg hover:bg-green-600 transition-colors transform hover:scale-105 text-start">
              <b>
                <a href="http://tiny.cc/adminkosi">Dapatkan Segera!</a>
              </b>
            </button>
          </div>
        </div>
